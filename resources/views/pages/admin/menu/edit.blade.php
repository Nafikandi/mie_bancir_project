                ...
                <div class="col-md-8 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-create" method="POST" action="{{ route('menu.update', $menu->kd_menu) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input readonly="" type="text"
                                        class="form-control @error('kd_menu') is-invalid
                                    @enderror"
                                        id="kd_menu" name="kd_menu"
                                        value="{{ old('kd_menu') ? old('kd_menu') : $menu->kd_menu }}"
                                ...
                                <div class="row">
                                    ...
                                    @enderror"
                                            ...
                                            value="{{ old('name_menu') ? old('name_menu') : $menu->name_menu }}"
                                            placeholder="Nama Menu">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="name_menu">Ketersediaan Menu</label>
                                        <select name="status_menu" id="status_menu"
                                            class="form-control @error('status_menu')
                                            is-invalid
                                            @enderror">
                                            <option selected disabled>-- Pilih Ketersediaan --</option>
                                            <option value="tersedia"
                                                {{ $menu->status_menu == 'tersedia' ? 'selected' : '' }}>Tersedia</option>
                                            <option value="habis" {{ $menu->status_menu == 'habis' ? 'selected' : '' }}>
                                                Habis</option>
                                ...
                                <div class="row">
                                            ...
                                            @enderror">
                                                ...
                                                @foreach ($category as $item)
                                                    <option value="{{ $item->id }}"
                                                        {{ $item->id == $menu->category_menu ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number"
                                                value="{{ old('price_menu') ? old('price_menu') : $menu->price_menu }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="{{ url($menu->photo) }}" target="_blank">
                                        <img src="{{ url($menu->photo) }}" alt="" style="width:100px">
                                    </a>
                                </div>
                                <div class="form-group">
                                    <label>Upload Foto Menu Baru</label>
                                ...
                                <div class="form-group">
                                    ...
                                    @enderror"
                                        id="descripted_menu" name="descripted_menu" rows="4">
