...
<body>
                    ...
                    <li class="nav-item nav-search d-none d-lg-block">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="navbar-search-input"
                                placeholder="Cari Sesuatu" aria-label="search" aria-describedby="search">
                        </div>
                    </li>
                </ul>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                ...
                <footer class="footer text-center">
                    <span class="text-muted text-sm-left d-block d-sm-inline-block">Created by <a
                        href="#">Nafik andi</a></span>
                </footer>
                <!-- partial -->
            </div>
            <!-- main-panel ends -->
    ...
    <script src="{{ asset('venvendors/chart.js/Chart.min.js') }}"></script>
    ...
    <script src="{{ asset('vendors/js/Chart.roundedBarCharts.js') }}"></script>
